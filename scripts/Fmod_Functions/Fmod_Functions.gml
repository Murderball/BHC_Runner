...
{
    return fmod_studio_system_get_event_multiplatform(global.fmod_studio_system, _path);
}

/// @param {real} event_description_ref
function fmod_studio_event_description_create_instance(_event_description_ref)
{
    return fmod_studio_event_description_create_instance_multiplatform(_event_description_ref);
}

/// @param {real} event_instance_ref
function fmod_studio_event_instance_start(_event_instance_ref)
{
    return fmod_studio_event_instance_start_multiplatform(_event_instance_ref);
}

/// @param {real} event_instance_ref
function fmod_studio_event_instance_stop(_event_instance_ref, _mode)
{
    return fmod_studio_event_instance_stop_multiplatform(_event_instance_ref, _mode);
}

/// @param {real} event_instance_ref
function fmod_studio_event_instance_release(_event_instance_ref)
{
    return fmod_studio_event_instance_release_multiplatform(_event_instance_ref);
}
