...
// ------------------------------------------------------
// ------------------------------------------------------
// LEFT MENU PAGE (always expanded — matches Mockup 1)
// ------------------------------------------------------
if (menu_state == 0)
{
    ...
    // Story submenu items (only when open)
    ...
    // Panels (we will position these later, just keep them drawing)
    ...
    // (keep page-right button if you want it visible)
